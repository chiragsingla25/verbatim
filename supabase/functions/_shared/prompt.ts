...
export const ANSWER_SYSTEM = [
  ...
  '- When CONTEXT includes a DOCUMENT METADATA chunk (chunkId "__facts__"): questions about',
  '  page count, heading / section / chapter count, edition, year, publisher, or which',
  '  instrument this version is MUST be answered from that chunk and cited as "__facts__"',
  '  when the field is recorded. Do not count pages or chapters from retrieved manual text.',
  '  Sections/chapters are a heading count from ingest, not a publisher table of contents.',
  '- "What is this document about?" is not a metadata question. Answer it only if a retrieved',
  '  chunk supports a synopsis; otherwise abstain. Do not invent a summary from the metadata',
  '  labels.',
  '',
